...
import {
  ...
  BenefitsSection,
  CtaSection,
} from "@/lib/actions/site/membershipBenefitsPageAction";
...
export default function MembershipBenefitsClient({
  ...
  const findSection = <T extends MembershipPageData["sections"][number]>(
    type: T["fieldGroupName"],
  ) => {
    return sections.find((s) => s.fieldGroupName === type) as T | undefined;
  };

  const benefitsSection = findSection<BenefitsSection>(
    "MembershipPageBuilderMembershipPageBuilderBenefitsSectionLayout",
  );
  const ctaSection = findSection<CtaSection>(
    "MembershipPageBuilderMembershipPageBuilderCtaSectionLayout",
  );
    ...
    <div className="pt-25 pb-25">
      ...
      <div className="container max-w-7xl mx-auto px-4 md:px-6">
        ...
        {benefitsSection &&
          ...
          benefitsSection.benefits.length > 0 && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {benefitsSection.benefits.map((benefit, index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform ${isPurple ? "bg-club-purple/10 text-club-purple" : "bg-club-blue/10 text-club-blue"}`}
                      >
