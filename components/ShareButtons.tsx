    ...
    if (!mounted) {
        return (
            <div className="flex gap-2">
                <div className="w-10 h-10 rounded-full text-white opacity-50 flex items-center justify-center" style={{ backgroundColor: '#25D366' }}><WhatsAppIcon /></div>
                ...
                <div className="w-10 h-10 rounded-full bg-black text-white opacity-50 flex items-center justify-center"><XIcon /></div>
    ...
    return (
        <div className="flex gap-2">
            <a
                ...
                className="w-10 h-10 rounded-full text-white flex items-center justify-center hover:opacity-80 transition-all"
