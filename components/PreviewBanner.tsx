                ...
                <div className="flex items-center justify-between py-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-2">
                            <span className="font-semibold text-sm sm:text-base font-tajawal">
                                وضع المعاينة نشط
                            </span>
                            <span className="text-xs sm:text-sm text-white/90 font-tajawal">
                    ...
                    <button
                        onClick={handleExit}
                        disabled={isExiting}
                        className="flex items-center gap-2 px-4 py-2 bg-white text-orange-600 rounded-lg hover:bg-orange-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm font-medium font-tajawal"
                    >
                        {isExiting ? (
                            <>
